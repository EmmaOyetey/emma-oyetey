...
const Home = () => {
  return (
    <div className="home">
      ...
      <div id="about-me" className="home__about-me visible">
      ...
      <div id="where" className="home__section home__section--where visible">
      ...
      <div id="what">
        ...
        <div className="home__section home__section--what visible">
      ...
      <div id="who" className="home__section home__section--who visible">
